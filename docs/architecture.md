...
| AI Provider | OpenAI Responses API | `src/lib/ai.ts` |
...
4. Server sends the conversation into the configured OpenAI model.
5. Server returns the generated assistant reply.
